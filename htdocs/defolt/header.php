...
<body> 
    ...
    <?php include '../defolt/DB_config.php'; ?>
    <?php include '../DB_management/index.php'; ?>
    <div class="container"> 
            ...
            <nav class="header__menu navbar navbar-expand-lg navbar-dark"> 
                ...
                <div class="collapse navbar-collapse" id="navbarNav"> 
                    <ul class="navbar-nav"> 
                        ...
                        <li class="nav-item"><a class="nav-link" href="/LR5/">LR5</a></li> 
                        <li class="nav-item"><a class="nav-link" href="/LR6/">LR6</a></li> 
                    </ul> 
                </div> 
                <?php 
                if (isSessionActive()) { 
